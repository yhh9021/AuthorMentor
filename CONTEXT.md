...
**长程分段拆书**:
面向长篇小说的拆书方式，先建立全书结构，再按剧情阶段或默认章节区间逐段精拆，最后汇总、去重、归类并更新素材库。
_避免_: 只做一次总览拆书、只抽象不落细节

**持久拆书目录**:
每本被拆小说的长期沉淀目录，保存来源记录、全书地图、分段拆书、素材卡和最终汇总；原始正文副本可本地保存但不提交到远程 Git。
_避免_: 一次性运行目录、把原始正文提交到远程仓库

**分段拆书报告**:
长程分段拆书中针对一个剧情阶段或章节区间的结构化报告，记录阶段目标、事件链、设定用法、人物关系、冲突、爽点、钩子、桥段和复用风险。
_避免_: 全书总览、章节流水账

**素材卡**:
从拆书中提取的细粒度可复用生产资产，记录一个设定模式、剧情桥段、爽点、钩子、伏笔、人物关系、压力源、交易方式、战斗设计、节奏结构或趣味梗。
_避免_: 原文摘抄、无复用边界的灵感笔记
...
领域专家：“不够。长篇小说需要长程分段拆书，把全书结构、分段细节和素材卡都沉淀下来。”
